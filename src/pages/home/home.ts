...
export class HomePage {    
    ...
    eventsCalendar = [];
    contadorCitas = 0;
    bodyNotification:string = "Consultando citas de su agenda";

    
  constructor(public nativeAudio: NativeAudio , private backgroundMode: BackgroundMode,public navCtrl: NavController, private http:Http,private alertCtrl: AlertController, private database: DatabaseProvider) {
    ...
    this.backgroundMode.setDefaults({
        ...
        icon: 'icon2', // this will look for icon.png in platforms/android/res/drawable|mipmap
